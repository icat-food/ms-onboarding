...
import com.icat.orboarding.user.adapters.inbound.dtos.response.toTokenDTO
...
class AuthenticationController(
    ...
    fun login(@RequestBody @Validated loginDTO: LoginDTO): ResponseEntity<TokenDTO> {
        return ResponseEntity.ok(authenticationServicePort.authenticate(loginDTO).toTokenDTO())
    }
}